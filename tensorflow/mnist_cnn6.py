...
RUTA_SALIDA = './modelo_entrenado_mnist_cnn6/'
...
wc2 = tf.Variable(tf.truncated_normal([1,1,3,2], stddev=0.1), name="W_c2")
bc2 = tf.Variable(tf.truncated_normal([2], stddev=0.1), name="b_c2")

wn1 = tf.Variable(tf.truncated_normal([14*14*2, 10], stddev=0.1), name="W_n1")
...
conv2r_1D = tf.reshape(conv2r, shape=[-1, 14*14*2])
