...
RUTA_SALIDA_C = 'modelo_entrenado_mnist_cnn11/'
...
with tf.Session() as sess:
    ...
    # CONV 2
    strFiltroActual = "2"
    shapeFiltroActual = [4,7,7,8] # CanalesEntrada, FilasFiltro, ColumnasFiltro, CanalesFiltro
    ...
    with open("./ficheros_c/"+RUTA_SALIDA_C+"wn1.h", 'w') as file:
        NUM_CONEXIONES_POR_NEURONA = 14*14*8
        string = "float wn1[] = {";
        for k in range(10):
