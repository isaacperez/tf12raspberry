...
RUTA_SALIDA = './modelo_entrenado_mnist_cnn12/'
...
wc1 = tf.Variable(tf.truncated_normal([7,7,1,8], stddev=0.1), name="W_c1")
bc1 = tf.Variable(tf.truncated_normal([8], stddev=0.1), name="b_c1")

wc2 = tf.Variable(tf.truncated_normal([3,3,8,12], stddev=0.1), name="W_c2")
bc2 = tf.Variable(tf.truncated_normal([12], stddev=0.1), name="b_c2")

wc3 = tf.Variable(tf.truncated_normal([1,1,8,8], stddev=0.1), name="W_c3")
bc3 = tf.Variable(tf.truncated_normal([8], stddev=0.1), name="b_c3")

wc4 = tf.Variable(tf.truncated_normal([1,1,12,16], stddev=0.1), name="W_c4")
bc4 = tf.Variable(tf.truncated_normal([16], stddev=0.1), name="b_c4")

wc5 = tf.Variable(tf.truncated_normal([3,3,8,16], stddev=0.1), name="W_c5")
bc5 = tf.Variable(tf.truncated_normal([16], stddev=0.1), name="b_c5")

wn1 = tf.Variable(tf.truncated_normal([16, 10], stddev=0.1), name="W_n1")
...
# Conv3
conv3 = tf.nn.conv2d(conv1r, wc3, strides=[1, 1, 1, 1], padding='SAME')
