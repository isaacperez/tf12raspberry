...
RUTA_SALIDA_C = 'modelo_entrenado_mnist_cnn12/'
...
with tf.Session() as sess:
    ...
    # CONV 1
    strFiltroActual = "1"
    shapeFiltroActual = [1,7,7,8] # CanalesEntrada, FilasFiltro, ColumnasFiltro, CanalesFiltro
    ...
    # CONV 3
    strFiltroActual = "3"
    shapeFiltroActual = [8,1,1,8] # CanalesEntrada, FilasFiltro, ColumnasFiltro, CanalesFiltro
    wc_np, bc_np = sess.run([wc3, bc3])
    guardarFiltroEnFormatoC(shapeFiltroActual, wc_np, bc_np)

    # CONV 4
    strFiltroActual = "4"
    shapeFiltroActual = [12,1,1,16] # CanalesEntrada, FilasFiltro, ColumnasFiltro, CanalesFiltro
    wc_np, bc_np = sess.run([wc4, bc4])
    guardarFiltroEnFormatoC(shapeFiltroActual, wc_np, bc_np)

    # CONV 5
    strFiltroActual = "5"
    shapeFiltroActual = [8,3,3,16] # CanalesEntrada, FilasFiltro, ColumnasFiltro, CanalesFiltro
