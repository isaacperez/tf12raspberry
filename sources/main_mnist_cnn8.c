...
int main()
{
  ...
  // CONV 1X1 S1
  NUM_FILTROS = 2;
  STEP_FILA_OUTPUT = NUM_COLUMNAS*NUM_FILTROS; // 16 píxeles en una fila * canales==num_filtros
  STEP_COLUMNA_OUTPUT = NUM_FILTROS;

  t = clock();
  img_segunda_conv_ptr = Convolucion_1x1_S1(img_conv_1x1_S1_ptr, img_segunda_conv_ptr, wc2_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA, STEP_FILA_OUTPUT, STEP_COLUMNA_OUTPUT, NUM_FILTROS);
  t = clock() - t;
  time_taken = ((double)t)/CLOCKS_PER_SEC; // in seconds
  ...
  printf("\n======== Convolucion_1x1_S1(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2) ========\n");
  printf("Convolucion_1x1_S1() tardó %f segundos en ejecutarse \n", time_taken);
  ...
  printf("\n======== suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2) ========\n");
  printf("suma_vector_con_tensor_por_canales() tardó %f segundos en ejecutarse \n", time_taken);
  //visualizarImagen(img_segunda_conv_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA);
  ...
  printf("\n======== ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2)) ========\n");
  printf("ReLU() tardó %f segundos en ejecutarse \n", time_taken);
  //visualizarImagen(img_segunda_conv_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA);
  ...
  printf("\n======== producto_tensores(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2)), Wn1) ========\n");
  ...
  printf("\n======== suma_vector_con_tensor_por_canales(producto_tensores(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2)), Wn1)) ========\n");
  printf("suma_vector_con_tensor_por_canales() tardó %f segundos en ejecutarse \n", time_taken);
  visualizarImagen(producto_tensores_ptr, 1, 1, 10, 1, 1);
