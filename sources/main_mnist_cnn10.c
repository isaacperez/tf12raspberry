...
int main()
{
  ...
  float *img_conv4_ptr = (float *) calloc(9 * 9 * 12, sizeof(float));
  float *img_conv5_ptr = (float *) calloc(9 * 9 * 12, sizeof(float));

  float *img_avg_global_ptr = (float *) calloc(12, sizeof(float));
  ...
  t = clock();
  img_max_pool_ptr = Avg_Pooling_2x2_S2(img_conv1_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA, STEP_FILA_OUTPUT, PADDING, PADDING, img_max_pool_ptr);
  t = clock() - t;
  time_taken = ((double)t)/CLOCKS_PER_SEC; // in seconds
  ...
  t = clock();
  img_conv2_ptr = Convolucion_3x3_S1(img_max_pool_ptr, img_conv2_ptr, wc2_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA, STEP_FILA_OUTPUT, STEP_COLUMNA_OUTPUT, NUM_FILTROS);
  t = clock() - t;
  time_taken = ((double)t)/CLOCKS_PER_SEC; // in seconds
  ...
  t = clock();
  img_conv3_ptr = Convolucion_1x1_S1(img_max_pool_ptr, img_conv3_ptr, wc3_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA, STEP_FILA_OUTPUT, STEP_COLUMNA_OUTPUT, NUM_FILTROS);
  t = clock() - t;
  time_taken = ((double)t)/CLOCKS_PER_SEC; // in seconds
  ...
  t = clock();
  img_conv4_ptr = Convolucion_3x3_S2(img_conv2_ptr, img_conv4_ptr, wc4_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA, STEP_FILA_OUTPUT, STEP_COLUMNA_OUTPUT, NUM_FILTROS);
  t = clock() - t;
  time_taken = ((double)t)/CLOCKS_PER_SEC; // in seconds
  ...
  t = clock();
  img_conv5_ptr = Convolucion_1x1_S2(img_conv3_ptr, img_conv5_ptr, wc5_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA, STEP_FILA_OUTPUT, STEP_COLUMNA_OUTPUT, NUM_FILTROS);
  t = clock() - t;
  time_taken = ((double)t)/CLOCKS_PER_SEC; // in seconds
