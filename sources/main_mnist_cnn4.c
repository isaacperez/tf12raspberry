...
int main()
{
  ...
  t = clock();
  img_segunda_conv_ptr = Convolucion_3x3_S2(img_conv_1x1_S1_ptr, img_segunda_conv_ptr, wc2_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA, STEP_FILA_OUTPUT, STEP_COLUMNA_OUTPUT, NUM_FILTROS);
  t = clock() - t;
  time_taken = ((double)t)/CLOCKS_PER_SEC; // in seconds
  ...
  printf("\n======== Convolucion_3x3_S2(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2) ========\n");
  ...
  printf("\n======== suma_vector_con_tensor_por_canales(Convolucion_3x3_S2(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2) ========\n");
  printf("suma_vector_con_tensor_por_canales() tardó %f segundos en ejecutarse \n", time_taken);
  //visualizarImagen(img_segunda_conv_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA);
  ...
  printf("\n======== ReLU(suma_vector_con_tensor_por_canales(Convolucion_3x3_S2(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2)) ========\n");
  printf("ReLU() tardó %f segundos en ejecutarse \n", time_taken);
  //visualizarImagen(img_segunda_conv_ptr, NUM_FILAS, NUM_COLUMNAS, NUM_CANALES, STEP_FILA, STEP_COLUMNA);
  ...
  printf("\n======== producto_tensores(ReLU(suma_vector_con_tensor_por_canales(Convolucion_3x3_S2(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2)), Wn1) ========\n");
  ...
  printf("\n======== suma_vector_con_tensor_por_canales(producto_tensores(ReLU(suma_vector_con_tensor_por_canales(Convolucion_3x3_S2(ReLU(suma_vector_con_tensor_por_canales(Convolucion_1x1_S1(IMAGEN INICIAL CON PADDING 1 POR CADA LADO, Wc1), bc1)), Wc2), bc2)), Wn1)) ========\n");
  printf("suma_vector_con_tensor_por_canales() tardó %f segundos en ejecutarse \n", time_taken);
  visualizarImagen(producto_tensores_ptr, 1, 1, 10, 1, 1);
